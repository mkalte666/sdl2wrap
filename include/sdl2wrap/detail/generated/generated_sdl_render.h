...
enum class RendererFlags : Uint32 {
    Software = SDL_RENDERER_SOFTWARE, ///< NOLINT \wrapImpl SDL_RENDERER_SOFTWARE RendererFlags::Software autogenerated
    Accelerated = SDL_RENDERER_ACCELERATED, ///< NOLINT \wrapImpl SDL_RENDERER_ACCELERATED RendererFlags::Accelerated autogenerated
    Presentvsync = SDL_RENDERER_PRESENTVSYNC, ///< NOLINT \wrapImpl SDL_RENDERER_PRESENTVSYNC RendererFlags::Presentvsync autogenerated
    Targettexture = SDL_RENDERER_TARGETTEXTURE, ///< NOLINT \wrapImpl SDL_RENDERER_TARGETTEXTURE RendererFlags::Targettexture autogenerated
};
...
enum class ScaleMode : Uint32 {
    Scalemodenearest = SDL_ScaleModeNearest, ///< NOLINT \wrapImpl SDL_ScaleModeNearest ScaleMode::Scalemodenearest autogenerated
    Scalemodelinear = SDL_ScaleModeLinear, ///< NOLINT \wrapImpl SDL_ScaleModeLinear ScaleMode::Scalemodelinear autogenerated
    Scalemodebest = SDL_ScaleModeBest, ///< NOLINT \wrapImpl SDL_ScaleModeBest ScaleMode::Scalemodebest autogenerated
};
...
enum class TextureAccess : Uint32 {
    Static = SDL_TEXTUREACCESS_STATIC, ///< NOLINT \wrapImpl SDL_TEXTUREACCESS_STATIC TextureAccess::Static autogenerated
    Streaming = SDL_TEXTUREACCESS_STREAMING, ///< NOLINT \wrapImpl SDL_TEXTUREACCESS_STREAMING TextureAccess::Streaming autogenerated
    Target = SDL_TEXTUREACCESS_TARGET, ///< NOLINT \wrapImpl SDL_TEXTUREACCESS_TARGET TextureAccess::Target autogenerated
};
...
enum class TextureModulate : Uint32 {
    None = SDL_TEXTUREMODULATE_NONE, ///< NOLINT \wrapImpl SDL_TEXTUREMODULATE_NONE TextureModulate::None autogenerated
    Color = SDL_TEXTUREMODULATE_COLOR, ///< NOLINT \wrapImpl SDL_TEXTUREMODULATE_COLOR TextureModulate::Color autogenerated
    Alpha = SDL_TEXTUREMODULATE_ALPHA, ///< NOLINT \wrapImpl SDL_TEXTUREMODULATE_ALPHA TextureModulate::Alpha autogenerated
};
...
enum class RendererFlip : Uint32 {
    None = SDL_FLIP_NONE, ///< NOLINT \wrapImpl SDL_FLIP_NONE RendererFlip::None autogenerated
    Horizontal = SDL_FLIP_HORIZONTAL, ///< NOLINT \wrapImpl SDL_FLIP_HORIZONTAL RendererFlip::Horizontal autogenerated
    Vertical = SDL_FLIP_VERTICAL, ///< NOLINT \wrapImpl SDL_FLIP_VERTICAL RendererFlip::Vertical autogenerated
};
